    ...
    events:
        ...
        - if <context.queue.exists>:
            - definemap embed_map.fields.2:
                    ...
                    value: Definitions:<n>```yaml<n><context.queue.definition_map.parse_value_tag[<[parse_value].as[element].length.is_more_than[50].if_true[<[parse_value].substring[1,50]>...].if_false[<[parse_value]>]>].to_yaml><n>```Linked player: <context.queue.player.if_null[none]><n>Linked npc: <context.queue.npc.if_null[none]>
